...
- The maintainer has exercised Codex and Kiro more directly than Claude, Gemini, Copilot, Cursor, and JetBrains so far, so some provider-specific edge cases may still surface in the wild.
