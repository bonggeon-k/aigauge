    ...
    <div className="space-y-4">
      <Card className="border-border/70 bg-card/90">
        ...
        <CardContent className="space-y-3 text-sm">
          ...
          <Button onClick={save} aria-label="Save settings">Save Settings</Button>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-2 text-sm">
          {shortcuts.map((item) => (
            <div key={item.id} className="flex items-center justify-between rounded-md border px-3 py-2">
              ...
              <kbd className="rounded bg-muted px-2 py-1 text-xs">{item.accelerator}</kbd>
            </div>
          ))}
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-3 text-sm">
          ...
          {plugins.map((plugin) => (
            <div key={plugin.id} className="rounded-md border px-3 py-2">
